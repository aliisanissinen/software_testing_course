...
describe("Testing words function", function() {
    ...
    it("2. Without pattern", function(done) {
        ...
        expect(words(simpleWordsWithSeparators[0])).to.be.a('Array').to.eql(simpleWordsWithSeparators[1]);
        expect(words(multiWordNames[0])).to.be.a('Array').to.eql(multiWordNames[1]);
        expect(words(namesWithNumbers[0])).to.be.a('Array').to.eql(namesWithNumbers[1]);
    ...
    it("3. With pattern", function(done) {
        ...
        expect(words(simpleWords[0], pattern)).to.be.a('Array').to.eql(simpleWords[2]);
        expect(words(simpleWordsWithSeparators[0], pattern)).to.be.a('Array').to.eql(simpleWordsWithSeparators[2]);
        expect(words(multiWordNames[0], pattern)).to.be.a('Array').to.eql(multiWordNames[2]);
        expect(words(namesWithNumbers[0], pattern)).to.be.a('Array').to.eql(namesWithNumbers[2]);
        expect(words(justSeparators[0], pattern)).to.be.a('Array').to.eql(justSeparators[2]);
        done();
    });
});