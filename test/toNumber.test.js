...
describe("Testing toNumber function", function() {
    ...
    describe("2. Value can be converted to number", function() {
        ...
        it("2.g binary", function(done) {
            ...
            expect(toNumber(originalnumber.toString(2))).to.be.a('number').to.eql(originalnumber);
            done();
        });

        it("2.h octal", function(done) {
            const originalnumber = 505;
            expect(toNumber(originalnumber.toString(8))).to.be.a('number').to.eql(originalnumber);
            done();
        });

        it("2.i hex", function(done) {
            const originalnumber = 606;
            expect(toNumber(originalnumber.toString(16))).to.be.a('number').to.eql(originalnumber);
            done();
        });
    });
